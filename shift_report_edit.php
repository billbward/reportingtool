                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        <li>
                            <a href="activity_report.php">
                                <div>
                                    <i class="fa fa-tasks fa-fw"></i> Statewide Activity Report
                                </div>
                            </a>
                        </li>
                        <li class="divider"></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-alerts">
                                        ...
                                        while ($rselect_row = mysqli_fetch_array($rselect_result,MYSQL_ASSOC)) {
                                            echo '<li>';
                                            echo '<a href="shift_report_edit.php?id=' . $rselect_row['region'] . '#dataTables-example">';
                                            echo '<div>';
                                    ...
                                    <?php 
                                            ...
                                            $sl_query = "select sl
                                                    ...
                                                    //open_status    
                                                        ...
                                                        /*elseif ($sl_row['open_status'] == 'Closed') {
