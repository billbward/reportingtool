            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        <li>
                            <a href="staging_location_snapshot.php">
                                <div>
                                    <i class="fa fa-tasks fa-fw"></i> Staging Location Snapshot
                                </div>
                            </a>
                        </li>
                        <li class="divider"></li>
        ...
        <!--<div id="page-wrapper"> -->
            <div class="row">
                <div class="col-lg-4 col-lg-offset-4">
                    <h1 class="page-header" style="text-align:center;">Statewide Activity Summary</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-10 col-lg-offset-1">
                    <div class="panel panel-orange">
                        <div class="panel-heading">
                            <strong>Statewide Activity Today</strong>
                        </div>
                        <!-- /.panel-heading -->
                                    ...
                                    <thead>
                                        <tr>
                                           <th class="col-lg-2">State</th>
                                            <th style='text-align:center;'>Open SLs</th>
            ...
            <!-- /.row -->
                ...
                <div class="col-lg-10 col-lg-offset-1">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <strong>Regional Activity Today</strong>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
